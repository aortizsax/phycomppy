...
project_init = _read(["src", "phycomppy", "__init__.py"])
...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "phycomppy = phycomppy.application.phycomppy:main",
        ]
    },
    ...
    package_data={
        ...
        "phycomppy": [
            ...
            # For files located in 'src/phycomppy-data/'
            # "../phycomppy-data/*.json",
    ...
    test_suite = "tests",
    # url="http://pypi.python.org/pypi/phycomppy",
    url="https://github.com/jeetsukumaran/phycomppy",
    license="LICENSE",
